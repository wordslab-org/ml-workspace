...
wget --retry-on-http-error=429 --waitretry 15 --tries 5 --no-verbose https://marketplace.visualstudio.com/_apis/public/gallery/publishers/esbenp/vsextensions/prettier-vscode/$PRETTIER_VERSION/vspackage -O prettier-vscode-$PRETTIER_VERSION.vsix
...
wget --retry-on-http-error=429 --waitretry 15 --tries 5 --no-verbose https://marketplace.visualstudio.com/_apis/public/gallery/publishers/formulahendry/vsextensions/code-runner/$VS_CODE_RUNNER_VERSION/vspackage -O code-runner-$VS_CODE_RUNNER_VERSION.vsix
